...
print("🦞 OpenClaw AI Trader v4.1 (терпеливый инвестор)")
print("=" * 50)
...
- МИНИМУМ 5 ДНЕЙ удержания! Не продавай то, что купил менее 5 торговых дней назад. Терпение = прибыль
- ПРОДАЖА В МИНУС — только при пробое стоп-лосса! Если бумага просела, но стоп-лосс не пробит — ДЕРЖИ. Не паникуй из-за временной просадки
- Продажа В ПЛЮС — можно в любой момент, если цель достигнута или есть серьёзные причины (негативные новости, пробой поддержки)
- HOLD — это НОРМАЛЬНО! Если нет сильного сигнала — просто скажи HOLD. Лучшая сделка — это отсутствие сделки
- На ПАДАЮЩЕМ рынке (индекс ниже 2850) — предпочитай HOLD
- Не покупай бумагу, которая падает 3+ дня подряд
- ГЕОПОЛИТИКА ВАЖНЕЕ ФУНДАМЕНТАЛА на российском рынке. Не покупай против геополитического тренда. Переговоры по Украине, Иран, санкции, ставка ЦБ — вот что двигает рынок, а не отчёты компаний
...
- Помни: частые сделки = смерть портфеля через комиссии. Покупай редко, но метко
